...
Spore.prototype.update = function() {
    ...
    //Randomly increase or decrease horizontal and vertical speed//
    ...
    //Cap the max speed so it doesnt get out of control//
    this.speedCap();

    //Update the position by addng the speed to it//
